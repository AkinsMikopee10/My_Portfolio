...
const About = () => {
  return (
    <section id="about" className="py-20 container mx-auto px-6 gap-10">
      <MotionWrapper>
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-2/3 text-center md:text-left">
            ...
            <p>
              My goal is to contribute to impactful projects, continuously
              learn, and deliver value through creative solutions.
            </p>
          </div>
        </div>
      </MotionWrapper>
